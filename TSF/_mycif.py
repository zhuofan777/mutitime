...
__all__ = ["NewCanonicalIntervalForest"]
...
class NewCanonicalIntervalForest(BaseClassifier):
    ...
    def __init__(
        ...
        super(NewCanonicalIntervalForest, self).__init__()
    ...
    def _fit_estimator(self, X, y, idx):
        ...
        dims = rng.choice(self.dim_pool, self._n_intervals, replace=True)
        # print(self.dim_pool)
        # print(self.n_dims_)
        # print(self._n_intervals)
        # print()
        # print(dims)
        # print()
